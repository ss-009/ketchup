...
<div class="card">
	<div class="content-confirm form-m">
		<div class="content-header">{{ __('質問の投稿') }}</div>
		<form method="POST" action="question/confirm">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<input id="question_title" type="text" class="form-control @error('question_title') is-invalid @enderror" name="question_title" value="{{ old('question_title') }}" placeholder="5文字以上30文字以下" maxlength="30" required autocomplete="question_title">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<textarea id="question_content" type="text" class="form-control @error('question_content') is-invalid @enderror" name="question_content" placeholder="5文字以上2000文字以下" maxlength="2000" required>{{ old('question_content') }}</textarea>
