...
<div class="card">
	<div class="card-header">{{ __('質問の補足') }}</div>
	...
	<div class="card-body">
		<form method="POST" action="addition/confirm">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<textarea id="question_addition" type="text" class="form-control @error('question_addition') is-invalid @enderror" name="question_addition" required>{{ old('question_addition') }}</textarea>
